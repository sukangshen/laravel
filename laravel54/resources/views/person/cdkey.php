                ...
                <div class="nav-section" style="padding-bottom:0">
                    ...
                    <ul class="icon-filter">
                        ...
                        <li id="CDKey_change-li">
                            <a menu="cdkey" href="http://i.huya.com/index.php?m=CdKey" class="selected">
                ...
                <div class="mod-bd">
                    <form class="form form-apply" style="padding: 0 60px;">
                        ...
                        <div class="form-group">
                            ...
                            <input id="exchange_code" name="exchange_code" class="yy-num" maxlength="32" type="text">
                        ...
                        <div class="form-group" style="width:705px;">
                            ...
                            <input id="captcha_input" name="captchaValue" class="yy-num" maxlength="8" type="text">
                            <input id="captcha_id" name="captchaId" value="" type="hidden">
