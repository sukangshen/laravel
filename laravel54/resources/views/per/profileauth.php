    ...
    <div class="duya-header-wrap clearfix">
        <div class="duya-header-bd clearfix">
            ...
            <div class="duya-header-search clearfix">
                <form method="get" id="searchForm_id" name="navSearchForm" action="" target="_blank">
	            ...
	            <ul id="anth_main" class="auth_type">
	             ...
	             <table class="info_set" cellspacing="0" cellpadding="0" border="0">
	             	<tbody><tr>
	             		...
	             		<td class="td_2">
	             			<div>
	             				<input class="phone_num" id="anchor_nick" name="username" placeholder="控制在6个汉字以内最佳" type="text">
	             	...
	             	<tr>
                        <td class="td_1">身份证号码：</td>
                                <td class="td_2">                                        
                                               <input class="phone_num" id="anchor_nick" name="card" placeholder="请填写正确的身份证号码" type="text"></div>
